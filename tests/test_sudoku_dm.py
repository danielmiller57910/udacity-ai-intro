...
class TestDMUtils(unittest.TestCase):
    ...
    def test_create_grid_columns_and_rows(self):
        grid_cols, grid_rows = sudoku_dm.create_grid_columns(), sudoku_dm.create_grid_rows()
    ...
    def test_setup_grid(self):
        grid_board = sudoku_dm.grid_values(SAMPLE_GRID)
    ...
    def test_empty_index(self):
        ...
        self.assertEqual(sudoku_dm.empty_grid_indexes(sample_dict), ["A1", "A3"])
